...
/**
 * LogsAdminSearch represents the model behind the search form of `app\modules\logs_admin\models\LogsAdmin`.
 */
class LogsAdminSearch extends LogsAdmin
{
    ...
    public function rules()
    {
        return [
            ...
            [['created_at','date_from','date_to'], 'safe'],
        ];
    }
    ...
    {
        $query = LogsAdmin::find()->orderBy(['id' => SORT_DESC]);
